...
DEMO_DB_PATH = ROOT_DIR / "consensusdev.db"
DEMO_DATABASE_URL = f"sqlite:///{DEMO_DB_PATH}"


def clean_demo_database():
    print("[*] Cleaning Demo SQLite database (consensusdev.db, preserving users table)...")
...
def main():
    print("=" * 70)
    print(" [LAUNCH] GENERATING FINAL 4-REVIEW DEMO STORY DATASET")
    print("=" * 70)
...
"""
    ...
    print("\n" + "=" * 70)
    print(" [SUCCESS] FINAL DEMO DATASET GENERATION COMPLETE!")
    print("=" * 70)
